defmodule BackendWeb.UserControllerTest do
  ...
  @create_attrs %{email: "some email", name: "some name", surname: "some surname"}
  @update_attrs %{email: "some updated email", name: "some updated name", surname: "some updated surname"}
